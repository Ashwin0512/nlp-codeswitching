...
def to_cs(base_sentence, dependency_parser, translate, space):
    ...
    svg = displacy.render(tokenized,style='dep',jupyter=False)
    file_name = "dependency_tree_2.svg"
    output_path = Path("/Users/ashwin/Acads/4-1/NLP_Project/CSify/demo/data/" + file_name)
